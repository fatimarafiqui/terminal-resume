...
<html lang="en">
	<head>
		...
		<meta property="og:description" content="Resume of Fatima Rafiqui" />
		<meta property="og:url" content="http://fatimarafiqui.com/resume/" />
		<meta property="og:image" content="http://fatimarafiqui.com/resume/img/og_terminal_resume.png" />
			...
			<div class="icons">
				<div>
					<a href="/resume.pdf" target="_blank">
						<img src="img/pdf.png" width="64px"/>
						<br/>
						Resume.pdf
					</a>
				</div>
			</div>
			<div class="shell-wrap" style="display:none;">
				<p class="shell-top-bar">
					<a href="#" class="close left">close</a>
					<a href="#" class="minimize left">minimize</a>
					<a href="#" class="maximize left">maximize</a>
